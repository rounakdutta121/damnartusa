...
import { 
  ...
  Heart, ShoppingCart, Linkedin, MessageSquare, Shield, Users, Briefcase
} from 'lucide-react';
                ...
                <div className="relative">
                  ...
                  <div className="relative aspect-square rounded-3xl overflow-hidden border border-white/10 bg-slate-900 flex items-center justify-center">
                    ...
                    <div className="absolute bottom-8 left-8">
                      ...
                      <div className="text-blue-500 font-bold uppercase tracking-widest text-xs">Data Solutions</div>
                    </div>
                  </div>
                </div>
              </FadeIn>
                ...
                <form className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <select defaultValue="Data Mining" className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-2xl focus:outline-none focus:border-blue-500 text-white transition-all appearance-none">
