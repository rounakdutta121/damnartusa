    ...
    <div className="min-h-screen pt-32 pb-16 section-dark">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-invert prose-lg max-w-none text-slate-400">
          ...
          <p>DamnArt respects your privacy and is committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website.</p>
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Contact Us</h2>
          <p>If you have any questions about this privacy policy, please contact us at info@damnart.com.</p>
        </div>
        <div className="mt-12">
